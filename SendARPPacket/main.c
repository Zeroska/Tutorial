...
//Can use most of the lib in mac os
...
#include <netinet/if_ether.h>   // defines values for argument "request" of ioctl.
#include <net/if.h>           // struct ifreq
#include <netinet/in_arp.h>  // ETH_P_ARP = 0x0806
 // struct sockaddr_ll (see man 7 packet)
